...
lg_button = Button(st,text="Log-Out",font=("Time New Roman", 15,"bold"),relief=RAISED, cursor="plus",command=log_out)
lg_button.place(x=150,y=270,height=50,width=200)

st_button = Button(st,text="Shut Dowm",font=("Time New Roman", 15,"bold"),relief=RAISED, cursor="plus",command=shutdown)
